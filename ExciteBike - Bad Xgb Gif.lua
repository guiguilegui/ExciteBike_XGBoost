...
dofile("C:\\Users\\Guillaume\\Documents\\Nes\\Excitebike\\xgbdumpBad")
...
while memory.readbyte(0x52) == 0 do
	...
	-- Take screenshot -- 
	client.screenshot("img/ExcitebikeXgb" .. string.format("%04d", iteration) ..".png")
...
os.execute('convert -delay 3.3333 -loop 0 ./img/ExcitebikeXgb*.png ./img/ExcitebikeXgb.gif') -- 3.3333 = 100 ticks per second for ImageMagick / 60 frame per second for the NES / only ¼ of the frames with screenshot / 2 times faster GIF.